  ...
  return div(
    ...
    toList([
      label(
        ...
        toList([
          span(toList([]), toList([text3("Enter a name: ")])),
          input(
            toList([
              value(model),
              on_input((var0) => {
      ...
      p(
        toList([]),
        toList([text3("Hello there, "), text3(model), text3("!")])
      )
    ])
  );
}
function main() {
  ...
  if (!($ instanceof Ok)) {
    throw makeError(
      ...
      { value: $, start: 388, end: 437, pattern_start: 399, pattern_end: 404 }
    );
  }
  return void 0;
}
